            ...
            <main className=' bg-gray-900 dark:bg-gray-300 '>
                {
                    loading ? <Loading /> :
                        <div>
                            <article className=' relative backgroundImage' >
                                <div className="absolute inset-0 bg-opacity-90 bg-slate-900"></div>
                                <h1 className='text-center text-5xl opacity-85 text-secondary pt-14 pb-10  md:py-20 lg:py-32'>About Us </h1>
                            </article>
                            <section>
                                <article className='w-11/12 m-auto py-10 md:p-10 '>
                                    <div className='flex justify-around flex-wrap md:flex-nowrap gap-5 '>
                                        <img className='hover:scale-110 transition-all h-60 md:h-64 lg:h-72 w-auto' src={image1} />
                                        <div>
                            ...
                            <section className='w-11/12 m-auto '>
                                <article data-aos="zoom-in-up" className=' flex-wrap flex gap-5 items-center text-gray-300 p-10 dark:text-gray-900  '>
                                    ...
                                    <p className='text-xl md:text-3xl flex flex-col gap-2' >CONTACT <br />
                                        <span className='md:text-2xl text-sm'>Smart: 070 27 14 45 </span>
                                        <span className='md:text-2xl  text-sm'> Cellcard: 012 ## ## ## </span>
                                    </p>
                                </article>
                                <article data-aos="zoom-in-up" className=' flex justify-end flex-wrap gap-5 items-center text-gray-300 p-10 dark:text-gray-900 '>
                                    <p className='text-xl  md:text-3xl ' >Internet Contact <br />
                                        <Link  to='/contact'  className='text-sm flex flex-col gap-2 md:text-2xl'>
                                        <span>Gmail: WWW.###@gmail.com </span>
                                        <span>Outlook:www.###@outlook.com</span>
                                        </Link>
                         
                                    </p>
                                    <span className='text-white' >
                                        <svg className='w-20 h-20  md:w-24 md:h-24 icon-secondary dark:fill-blue-600' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M57.7 193l9.4 16.4c8.3 14.5 21.9 25.2 38 29.8L163 255.7c17.2 4.9 29 20.6 29 38.5l0 39.9c0 11 6.2 21 16 25.9s16 14.9 16 25.9l0 39c0 15.6 14.9 26.9 29.9 22.6c16.1-4.6 28.6-17.5 32.7-33.8l2.8-11.2c4.2-16.9 15.2-31.4 30.3-40l8.1-4.6c15-8.5 24.2-24.5 24.2-41.7l0-8.3c0-12.7-5.1-24.9-14.1-33.9l-3.9-3.9c-9-9-21.2-14.1-33.9-14.1L257 256c-11.1 0-22.1-2.9-31.8-8.4l-34.5-19.7c-4.3-2.5-7.6-6.5-9.2-11.2c-3.2-9.6 1.1-20 10.2-24.5l5.9-3c6.6-3.3 14.3-3.9 21.3-1.5l23.2 7.7c8.2 2.7 17.2-.4 21.9-7.5c4.7-7 4.2-16.3-1.2-22.8l-13.6-16.3c-10-12-9.9-29.5 .3-41.3l15.7-18.3c8.8-10.3 10.2-25 3.5-36.7l-2.4-4.2c-3.5-.2-6.9-.3-10.4-.3C163.1 48 84.4 108.9 57.7 193zM464 256c0-36.8-9.6-71.4-26.4-101.5L412 164.8c-15.7 6.3-23.8 23.8-18.5 39.8l16.9 50.7c3.5 10.4 12 18.3 22.6 20.9l29.1 7.3c1.2-9 1.8-18.2 1.8-27.5zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z" /></svg>
                                    </span>
                                </article>
                                <article className='flex justify-around flex-wrap md:flex-nowrap gap-5 py-10'>
                                    <article data-aos="zoom-in-up" className=' flex justify-start gap-5 items-center text-gray-300 p-10 dark:text-gray-900 '>
                                        ...
                                        <p className=' text-sm  md:text-3xl flex flex-col gap-2' >Facebook <br />
                                            <Link  to='/contact'  className='md:text-2xl'>UserName... </Link>
                                            <Link  to='/contact'  className='md:text-2xl'> Pages: PageName...... </Link>
                                        </p>
                                    </article>
                                    <article data-aos="zoom-in-up" className=' flex justify-start gap-5 items-center text-gray-300 p-10  dark:text-gray-900'>
                                        <p className=' text-sm  md:text-3xl flex flex-col gap-2' >Telegram <br />
                                            <Link to='/contact' className='md:text-2xl'>UserName... </Link>
                                            <Link  to='/contact'  className='md:text-2xl'> Group: grouplink...... </Link>
                                        </p>
                                        <span className='text-white' >
